...
<div class="row-register row-register-box">
	<div class="form-field col-md-1 col">
		<div class="form-group">
			<label>Title</label>
			<select name="{{$i}}_title" id="{{$i}}_title" class="sel-countrie form-control">
	...
	<div class="form-field col-md-3 col">
		<div class="form-group">
			...
			<input type="text" value="{{$data != null ? $data->first_name : ''}}" class="form-control" id="{{$i}}_first_name" name="{{$i}}_first_name" placeholder="Your first name" required>
		</div>
	</div>
	<div class="form-field col-md-3 col">
		<div class="form-group">
			<label>Last Name <span class="text-danger">*</span></label>
			<input type="text" value="{{$data != null ? $data->last_name : ''}}" class="form-control" id="{{$i}}_last_name" name="{{$i}}_last_name" placeholder="Your last name" required>
		</div>
	</div>
	<div class="form-field col-md-3 col">
		<label>Date of birth <span class="text-danger">*</span></label>
		<div class="form-group col-md-3 pd4">
			<select name="{{$i}}_date" id="{{$i}}_date" class="form-control" required>
				@for ($x = 1; $x <= 31; $x++)
		...
		<div class="form-group col-md-5 pd4">
			<select name="{{$i}}_month" id="{{$i}}_month" class="form-control" required>
		...
		<div class="form-group col-md-4 pd4">
			<select name="{{$i}}_year" id="{{$i}}_year" class="form-control" required>
	...
	<div class="form-group col-md-2 col">
		...
		<select name="{{$i}}_gender" id="{{$i}}_gender" class="form-control" required>
	...
	<div class="form-field col-md-6 col">
		<div class="form-group">
			...
			<input type="text" value="{{$data != null ? $data->passport : ''}}" class="form-control" id="{{$i}}_pass" name="{{$i}}_pass" placeholder="Your Passport No">
		</div>
	</div>
	<div class="form-field col-md-6 col">
		<div class="form-group">
			<label>Country</label>
			<select name="{{$i}}_country" id="{{$i}}_country" class="form-control">
