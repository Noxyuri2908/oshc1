<thead class="">
    ...
    <tr class="last-row">
        ...
        <th class="d-flex">
            <input type="text" class="form-control mr-2" id="deadline_training_start" placeholder="Date start" value="{{date('Y-01-01')}}">
            <input type="text" class="form-control" id="deadline_training_end" placeholder="Date end" value="{{date('Y-m-d 23:59:59')}}">
        </th>
        <th>
