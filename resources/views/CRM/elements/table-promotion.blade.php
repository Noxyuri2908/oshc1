@if(session('error-list-promotion'))
  <div class="alert alert-danger">
    <strong>{{session('error-list-promotion')}}</strong>
  </div>
@endif
@if(session('success-list-promotion'))
  <div class="alert alert-success">
    <strong>{{session('success-list-promotion')}}</strong>
  </div>
@endif
<div class="card mb-3">
  <div class="card-header">
    <div class="row align-items-center">
      <div class="col">
        <h5 class="fs-0 mb-0">PROMOTIONS</h5>
      </div>
      <div class="col-auto">
        ...
        <tbody>
          @foreach($objs as $obj)
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle">{{number_format($obj->amount)}} {{!empty($currencyConfig[$obj->unit])?$currencyConfig[$obj->unit]:''}}</td>
              <td class="align-middle">
                @if($obj->status == 1)
...
<div id="div_edit_promotion"></div>
@include('CRM.elements.promotions.modal-add-new')
@include('CRM.elements.promotions.modal-delete')
