<div class="modal fade user-information" id="modal_campain_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="{{route('campain.store')}}" method="POST">
      @csrf
