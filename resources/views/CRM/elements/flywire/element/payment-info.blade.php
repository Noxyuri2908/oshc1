      ...
      <div class="card-body bg-light" data-id="payment">
          <div class="row">
              ...
              <div class="col-lg-2">
                  ...
                  <div class="input-group mb-3">
                      <input class="form-control" id="comm" name="comm" value="{{isset($obj) ? $obj->comm : 0}}" type="text" placeholder="" onfocus="this.blur()" >
                      <div class="input-group-append"><span class="input-group-text">{{!empty($obj)? $obj->provider->currency() : ''}}</span></div>
                  </div>
              </div>
              <div class="col-lg-2">
                  ...
                  <div class="input-group mb-3">
                      <input class="form-control" id="total" name="total" value="{{isset($obj) ? $obj->total : 0}}" type="text" placeholder="" onfocus="this.blur()" >
                      <div class="input-group-append"><span class="input-group-text">{{!empty($obj)? $obj->provider->currency() : ''}}</span></div>
                  </div>
              </div>
