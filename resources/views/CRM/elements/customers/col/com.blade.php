...
<tr class="first-row">
    ...
    <th class="width-150">Gross amount</th>
    <th class="width-150">Promotion $</th>
    <th class="width-150">Bank fee $</th>
    <th class="width-150">Extend fee</th>
    <th class="width-150">GST</th>
    <th class="width-150">Discount</th>
    <th class="width-150">Total $</th>
    <th class="width-150">Provider</th>
    <th class="width-150">Status</th>
    <th class="width-150">Type of service</th>
    <th class="width-150">Service country</th>
    <th class="width-150">Visa status</th>
    <th class="width-150">Month</th>
    <th class="width-150">Year</th>
    <th class="width-150">Date of payment provider</th>
    <th class="width-150">Bank account</th>
    <th class="width-150">Date of payment agent</th>
    <th class="width-150">Policy No</th>
    <th class="width-150">Agent com</th>
    <th class="width-150">Issue Date</th>
    <th class="width-150">Policy status</th>
    <th class="width-150">Payment note</th>
    <th class="width-150">Receipt amount</th>
    <th class="width-150">Note</th>
