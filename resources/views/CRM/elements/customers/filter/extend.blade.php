...
{{--    </th>--}}
    ...
    <th>
        <div>
            <select class="form-control" name="remind_status_filter" id="remind_status_filter">
                <option label=""></option>
                @if(!empty($remind_status))
                    @foreach($remind_status as $keyRemindStatus=>$valueRemindStatus)
                        <option
                            value="{{$keyRemindStatus}}">{{$valueRemindStatus['name']}}</option>
                    @endforeach
                @endif
            </select>
        </div>
    ...
    <th>
        <div>
            <input type="text" class="form-control" name="promotion_code_filter" id="promotion_code_filter">
        </div>
    </th>
    <th></th>
    <th></th>
