                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="input-contenr">
                            <input type="text" class="form-control"
                                   value="{{$resCus->first_name." ".$resCus->last_name}}" readonly>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="input-contenr">
                            <input type="text" class="form-control"
                                   value="{{$agent->name." (".$agent->info->agent_code.")"}}" readonly>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="phieuthu_account_bank">
                                            ...
                                            @foreach(getBank() as $key => $item)
                                                <option
                                                    value="{{$item->id}}" {{!empty($receipt) && $receipt->account_bank == $item->id ? 'selected':''}}>{{$item->account}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="input-contenr">
                            <input type="text" class="form-control" id="phieuthu_code"
                                   value="PT{{$obj->ref_no}}-{{$stt}}">
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        <label class="control-label">Date of receipt</label>
                        <div class="input-contenr">
                            <input type="text" class="form-control choose-date-form" id="date-receipt"
                                   value="{{date("d/m/Y")}}">
                        </div>
                    </div>
                    <div class="form-group clearfix">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control w-75" id="receipt_net_amount"
                                   value="{{number_format($obj->net_amount)}}">
...
@else
    ...
    <div class="cash-ch clearfix">
        ...
        <div class="radio-checked">
            <input type="radio" id="type_payment" name="type_payment"
                   value="2" {{$phieuthu->type_payment == 1 ? 'checked' : ''}}>
            <label for="chuyen-khoan">Chuyển khoản</label>
        </div>
    </div>
    <div class="form-row">
            ...
            <fieldset>
                ...
                <div class="form">
                    ...
                    <div class="form-group clearfix">
                        <label class="control-label">Note</label>
                        <div class="input-contenr">
                            <textarea name="" id="phieuthu_note" class="form-control" cols="30"
                                      rows="5">{{$phieuthu->note}}</textarea>
                        </div>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset>
                ...
                <div class="form">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="input-contenr">
                            <input type="text" class="form-control choose-date-form"
                                   value="{{convert_date_form_db($phieuthu->date_receipt)}}">
                        </div>
                    </div>
                    <div class="form-group clearfix">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="input-contenr">
                            <select class="form-control" id="phieuthu_current_id">
                                @foreach(config('myconfig.currency') as $key=>$value)
                                    <option
                                        value="{{$key}}" {{$phieuthu->current_id == $key ? 'selected' : ''}}>{{$value}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control w-75" id="receipt_net_amount"
                                   value="{{convert_price_float($phieuthu->receipt_net_amount)}}">
                            <div class="input-group-append"><span
                                    class="input-group-text">{{$obj->provider->currency()}}</span></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group clearfix">
                        <label class="control-label">Exchange rate</label>
                        <div class="input-contenr">
                            <input type="text" class="form-control" id="phieuthu_exchange_rate"
                                   value="{{$phieuthu_exchange_rate}}" readonly>
                        </div>
                    </div>
                    <div class="form-group clearfix">
                        <label class="control-label">Type of receipt</label>
                        <div class="input-contenr">
                            <select class="form-control" id="phieuthu_type">
                                @foreach(config('myconfig.type_receipt') as $key=>$value)
                                    <option
                                        value="{{$key}}" {{$phieuthu->type_receipt == $key ? 'selected' : ''}}>{{$value}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
