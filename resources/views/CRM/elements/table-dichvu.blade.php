@if(session('error-list-dichvu'))
  <div class="alert alert-danger">
    <strong>{{session('error-list-dichvu')}}</strong>
  </div>
@endif
@if(session('success-list-dichvu'))
  <div class="alert alert-success">
    <strong>{{session('success-list-dichvu')}}</strong>
  </div>
@endif
<div class="card mb-3">
  <div class="card-header">
    <div class="row align-items-center">
      <div class="col">
        <h5 class="fs-0 mb-0">SERVICES</h5>
      </div>
      <div class="col-auto">
        ...
        <tbody>
          @foreach($objs as $obj)
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle">{{$obj->slug}}</td>
              <td class="align-middle">{{isset(config('myconfig.type_form')[$obj->type_form]) ? config('myconfig.type_form')[$obj->type_form] : ''}}</td>
              <td class="align-middle">{{$obj->pos}}</td>
              <td class="align-middle">
                @if($obj->status == 1)
...
<div id="div_edit_dichvu"></div>
@include('CRM.elements.dichvu.modal-add-new')
@include('CRM.elements.dichvu.modal-delete')
