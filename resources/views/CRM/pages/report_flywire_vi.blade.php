        ...
        <table align="left" cellspacing="0" border="0" >
            ...
            @foreach($flywire as $items)
                ...
                <tr>
                    ...
                    <td colspan=2 align=center class="width-5 td_table_export_excel" style='font-family: "Times New Roman"'><span face="Times New Roman" style="font-size: 12.0pt;">{{$items->amount_from_unit == 156 ? 0 : $items->amount}}</span></td>  {{--promotion to aud--}}
