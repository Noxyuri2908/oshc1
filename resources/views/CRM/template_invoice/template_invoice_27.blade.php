    ...
    <page backcolor="#fff" id="example" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="68px" backright="16px" backbottom="42px" footer="page" style="font-family: cambria;font-size: 12pt">
        ...
        <table cellspacing="0" style="width: 100%; text-align: center; font-size: 10px;">
            <tr>
                <td rowspan="2" style="width: 50%;">
                    ...
                    <p style="text-align: left"><b style="font-size: 15px;">BIILING ADDRESS:</b> {{$dataInvoice['agentName']}}</p>
                    <p style="text-align: left">{{$dataInvoice['office']}}</p>
                </td>
                <td colspan="2" style="width: 50%;  text-align: center;">
                    ...
                    <div class="info-invoice" style="text-align: left;margin-left: 15rem;">
        ...
        <table id="table-2" cellspacing="0" style="width: 100%; font-size: 10px; border: none;">
            ...
            <tr>
                ...
                <td style=" text-align:center;"></td>
                <td style=" text-align:center;"></td>
                <td style=" font-size: 12pt; text-align:center;">{{$dataInvoice['tmp']}}</td>
            </tr>
            ...
            <tr >
                ...
                <td style="text-align: center; "><b style="font-size: 17px;">{{convert_price_float($dataInvoice['totalAmountReceivable'])}}</b></td>
            </tr>
        </table>
        <div id="editor"></div>
        <div id="more-imf">
