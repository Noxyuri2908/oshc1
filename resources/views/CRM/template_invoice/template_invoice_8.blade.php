    ...
    <page id="page" backcolor="#fff" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="16px" backright="16px" backbottom="42px" footer="page" style="background: #fff;">
        ...
        <table id="table-2" cellspacing="0" style="width: 100%;">
            ...
            <tr style=" text-align:center;">
                <th></th>
                <th></th>
                <th colspan="2" style="color: #fff; text-align:left; font-size: 9px; padding: 5px 15px; font-size: 9px;background-color: rgb(220,87,134); text-transform: uppercase" >Tổng số tiền phải thu (VND)</th>
                <th style=" color: #fff;text-align: left; padding: 5px 15px; font-size: 9px;background-color: rgb(220,87,134)">{{convert_price_float($dataInvoice['total'], 0)}} </th>
            </tr>
        </table>
        <br />
        <div id="more-imf">
