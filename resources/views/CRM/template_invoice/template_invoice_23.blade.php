...
<page backcolor="#fff" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="16px" backright="16px" backbottom="42px" footer="page" style="font-family: DejaVu Sans;font-size: 12pt">
    ...
    <div class="header" style="display: flex;justify-content: center;align-items: center">
        ...
        <div class="content-right" style="flex: 1">
            ...
            <p style="text-align: right; font-size: 9px;">Khách: {{ $dataInvoice['agentName']}}</p>
        </div>
    </div>
    ...
    <table id="table-2" cellspacing="0" style="width: 100%;">
        ...
        <tr id="th-header">
            <th style="width: 50%; text-align:left; background-color: #87cefa; text-transform: uppercase; font-size: 11px;">NGƯỜI ĐỀ NGHỊ</th>
        ...
        <tr style=" text-align:center;">
            <th></th>
            <th style=" text-align:left; font-size: 11px;" >PHÍ DỊCH VỤ:</th>
            <th></th>
            <th></th>
            <th></th>
            <th style="text-align: right">{{$dataInvoice['serviceCharge']}}</th>
        </tr>
        <tr style=" text-align:center;">
            <th></th>
            <th style=" text-align:left; font-size: 11px;" >phí chuyển/phụ phí:</th>
            <th></th>
            <th></th>
            <th></th>
            <th style="text-align: right">{{$dataInvoice['bank_fee']}}</th>
        </tr >
        @if($dataInvoice['currency'] != 'VND')
            <tr style=" text-align:center;">
                <th></th>
                ...
                <th></th>
                <th></th>
                <th style="text-align: right">{{convert_price_float($dataInvoice['totalAUD'])}}</th>
            </tr>
        @endif
        <tr style=" text-align:center;">
            <th></th>
            <th style=" text-align:left; font-size: 11px;" >TỔNG SỐ TIỀN THANH TOÁN(VND)</th>
            <th></th>
            <th></th>
            <th></th>
            <th style="text-align: right">{{convert_price_float($dataInvoice['totalVND'])}}</th>
        </tr>
    </table>
    <br />
    <div id="more-imf">
