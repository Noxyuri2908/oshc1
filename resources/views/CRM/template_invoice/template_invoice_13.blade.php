    ...
    <page id="page" backcolor="#fff" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="16px" backright="16px" backbottom="42px" footer="page" style="background: #fff;">
        ...
        <table id="table-2" cellspacing="0" style="width: 100%;">
            ...
            <tr id="td-content">
                ...
                <td>{{convert_price_float($dataInvoice['amount'])}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr>
                <th></th>
                <th></th>
                <th></th>
                <th colspan="2" style="color:#000" class="pl-29 text-right">Commission (include GST)</th>
                <td class="text-center" style="color:#000">{{$dataInvoice['comm']}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr >
                <th></th>
                <th></th>
                <th></th>
                <th colspan="2"  style="color: #000" class="text-right pl-29">GST</th>
                <td style="color: #000" class="text-center">{{$dataInvoice['gst']}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr >
            ...
            <tr style=" text-align:center;">
                ...
                <td id="total-rate">{{convert_price_float($dataInvoice['total'])}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr>
                <td></td>
                <td colspan="5" class="sub-des">
                    <i style="">Note: If you hold a student dependent visa, you must be insured under the same policy as the main</i><br>
                    <i style="">student visa holder. You are only eligible to hold a single policy if you are the primary visa holder.</i>
                </td>
            </tr>
        </table>
        <br />
