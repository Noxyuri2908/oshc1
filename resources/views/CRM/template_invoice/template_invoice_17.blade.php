...
@section('content')
    ...
    <page backcolor="#fff" id="example" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="68px" backright="16px" backbottom="42px" footer="page" style="font-family: cambria;font-size: 12pt">
            ...
            <tr>
                ...
                <td colspan="2" style="width: 50%;  text-align: center;">
                    <div class="logo-company" style="height: 126px">
                        <img style="width:230px" src="{{($dataInvoice['logo'])? $dataInvoice['logo'] : 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3'}}" alt="Logo" id="img" border="none">
                    </div>
                    <div class="info-invoice" style="text-align: left;margin-left: 5rem;">
        ...
        <table id="table-2" cellspacing="0" style="width: 100%; font-size: 10px; border: none;">
            ...
            <tr id="th-header">
                <th style="width: 25%; text-align:center; background-color: #87cefa; text-transform: uppercase; font-size: 13px;">ACTIVITY / PROVIDER</th>
                ...
                <th style="width: 20%; text-align:center; background-color: #87cefa; text-transform: uppercase; font-size: 13px;">AMOUNT (GST inclusive)</th>
            </tr>
            <tr>
                ...
                <td style=" font-size:12px; text-align:center;">{{$dataInvoice['amount']}}</td>
            </tr>
            <tr style="border-bottom: 1px dashed #4682b4;">
                <td style="font-size: 13px; text-align:center;">Promotion</td>
                <td style=" text-align:center;"></td>
                <td style=" text-align:center;"></td>
                <td style=" text-align:center;"></td>
                <td style=" font-size: 12pt; text-align:center;">{{$dataInvoice['promotion_amount']}}</td>
            </tr>
            <tr style="border-bottom: 1px dashed #4682b4;">
            ...
            <tr >
                ...
                <td style="text-align: center; "><b style="font-size: 17px;">{{$dataInvoice['amount']}}</b></td>
            </tr>
        </table>
        <div id="editor"></div>
        <div id="more-imf">
