    ...
    <page id="page" backcolor="#fff" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="16px" backright="16px" backbottom="42px" footer="page" style="background: #fff;">
        ...
        <table id="table-2" cellspacing="0" style="width: 100%;">
            ...
            <tr>
                ...
                <td style="padding: 5px 15px; font-size: 9px;">{{$dataInvoice['comm']}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr>
                <th></th>
                <th></th>
                <th colspan="2" style="padding: 5px 15px; font-size: 9px;">GST</th>
                <td style="padding: 5px 15px; font-size: 9px;">{{$dataInvoice['gst']}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr>
                <th></th>
                <th></th>
                <th colspan="2" style="padding: 5px 15px; font-size: 9px;">Surcharge fee</th>
            ...
            <tr style=" text-align:center;">
                ...
                <th style=" color: #fff;text-align: left; padding: 5px 15px; font-size: 9px;background-color: rgb(220,87,134)">{{convert_price_float($dataInvoice['total'])}} {{$dataInvoice['currency']}}</th>
            </tr>
            <tr>
