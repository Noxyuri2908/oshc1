    ...
    <page id="page" backcolor="#fff" backimgx="center" backimgy="bottom" backimgw="100%" backtop="42px" backleft="16px" backright="16px" backbottom="42px" footer="page" style="background: #fff;">
        ...
        <table id="table-2" cellspacing="0" style="width: 100%;">
            ...
            <tr id="td-content">
                ...
                <td style=" " class="text-center">{{convert_price_float($dataInvoice['amount'])}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr>
                <th></th>
                <th></th>
            ...
            <tr>
                ...
                <th></th>
                <th></th>
                <th colspan="2" class="pl-29 text-right " style="color: #000">Surcharge fee</th>
                <td class="text-center" style="color: #000">{{$dataInvoice['bank_fee']}} {{$dataInvoice['currency']}}</td>
            </tr>
            <tr >
