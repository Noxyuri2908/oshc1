	...
	<div class="row animated fadeInRight">
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<form id="form" class="form-horizontal" role="form" action="{{route('price.update',['id'=>$obj->id])}}" 
				enctype="multipart/form-data" method="POST">
				@method('PATCH')
				@csrf
					@include('back-end.price.form')
...
@include('back-end.partials.modals.import-data')
@endsection
@section('js')
<script>
