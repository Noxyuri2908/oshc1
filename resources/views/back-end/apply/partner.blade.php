<div class="panel-body">
    <fieldset class="form-horizontal">
        <input type="hidden" value="{{$cus->id}}" name="{{$i}}_id">
        <div class="form-group" >
            <label class="col-sm-2 control-label">Title</label>
            <div class="col-md-5">
                <select class="form-control m-b" name="{{$i}}_title">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="{{$i}}_first_name"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="{{$i}}_last_name"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="{{$i}}_dob" id="{{$i}}_dob" 
        ...
        <div class="form-group" >
            ...
            <div class="col-md-5">
                <select class="form-control m-b" name="{{$i}}_gender">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="{{$i}}_pass" id="{{$i}}_pass" 
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" class="form-control" name="{{$i}}_country" id="{{$i}}_country" 
