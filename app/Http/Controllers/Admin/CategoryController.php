...
class CategoryController extends Controller
{
    ...
    {
        $menu_headers = MenuHeader::where('status',1)->get();
        return view('back-end.category.create',['menu_headers'=>$menu_headers]);
    }
    ...
    public function edit($id)
    {
        ...
        $menu_headers = MenuHeader::where('status',1)->get();
        return view('back-end.category.edit',['obj'=>$obj, 'menu_headers'=>$menu_headers]);
    }
