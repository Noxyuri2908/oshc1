...
View::composer([
    ...
    $providers = Service::where('dichvu_id', 2)->pluck('name', 'id');
...
View::composer([
    ...
    $providers = Service::orderby('name')->where('status', 1)->get(['id', 'status', 'name']);
